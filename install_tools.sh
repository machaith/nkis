...
echo -e "\e[93mCopy using the mouse, ctrl-c will stop the script"
...
echo -e "\e[93mCopy the commands below to the new opened terminal and close the new terminal when finished"
echo -e "\e[93mWrite the commands yourself"
...
echo -e "\e[32mContains a number of commonly found printer exploits"
echo -e "\e[0m"
git clone https://github.com/MooseDojo/praedasploit /opt/praedasploit
echo "*************************************************************"
echo -e "\e[31mInstalling SQLMap"
echo -e "\e[32mSQL Injection tool"
echo -e "\e[0m"
git clone https://github.com/sqlmapproject/sqlmap /opt/sqlmap
echo "*************************************************************"
echo -e "\e[31mInstalling Recon-ng"
echo -e "\e[32mA full-featured web reconnaissance framework written in Python"
echo -e "\e[0m"
git clone https://bitbucket.org/LaNMaSteR53/recon-ng.git /opt/recon-ng
echo "*************************************************************"
echo -e "\e[31mInstalling Discover Scripts"
echo -e "\e[32mCustom bash scripts used to automate various pentesting tasks."
echo -e "\e[0m"
...
echo -e "\e[32m PowerTools is a collection of PowerShell projects with a focus on offensive operations."
echo -e "\e[0m"
git clone https://github.com/PowerShellEmpire/PowerTools.git
echo "*************************************************************"
echo -e "\e[31mInstalling PowerSploit -PowerShell"
echo -e "\e[32mPowerShell scripts for post exploitation"
echo -e "\e[0m"
...
echo -e "\e[32m Nishang - PowerShell for penetration testing and offensive security."
echo -e "\e[0m"
git clone https://github.com/samratashok/nishang.git
echo "*************************************************************"
echo -e "\e[31mInstalling DSHashes"
echo -e "\e[32mExtracts user hashes in a user-friendly format for NTDSXtract"
echo -e "\e[0m"
wget http://ptscripts.googlecode.com/svn/trunk/dshashes.py -O /opt/NTDSXtract/dshashes.py
echo "*************************************************************"
echo -e "\e[31mInstalling SPARTA"
echo -e "\e[32mA python GUI application which simplifies network infrastructure penetration testing" 
echo -e "\e[32mby aiding the penetration tester in the scanning and enumeration phase."
echo -e "\e[0m"
...
echo -e "\e[32mA automated pentesting toolset for MongoDB database servers and web applications."
echo -e "\e[0m"
git clone https://github.com/tcstool/NoSQLMap.git /opt/NoSQLMap
echo "*************************************************************"
echo -e "\e[31mInstalling Spiderfoot"
echo -e "\e[32mOpen Source Footprinting Tool"
echo -e "\e[0m"
...
echo -e "\e[32mWindows Credential Editor -WCE is used to pull passwords from memory"
echo -e "\e[0m"
mkdir /opt/wce
cd /opt/wce
...
echo -e "\e[32mUsed for pulling cleartext passwords from memory, Golden Ticket, skeleton key and more"
echo -e "\e[32mGrab the newest release from https://github.com/gentilkiwi/mimikatz/releases/latest"
echo -e "\e[0m"
cd /opt/ && wget http://blog.gentilkiwi.com/downloads/mimikatz_trunk.zip
unzip -d ./mimikatz mimikatz_trunk.zip
echo "*************************************************************"
echo -e "\e[31mInstalling SET"
echo -e "\e[32mSocial Engineering Toolkit -SET will be used for the social engineering campaigns"
echo -e "\e[0m"
git clone https://github.com/trustedsec/social-engineer-toolkit/ /opt/set/
cd /opt/set && ./setup.py install
echo "*************************************************************"
echo -e "\e[31mInstalling Veil-Framework"
echo -e "\e[32mA red team toolkit focused on evading detection. It currently contains Veil-Evasion for generating AV-evading payloads, Veil-Catapult for delivering them to targets,"
echo -e "\e[32mand Veil-PowerView for gaining situational awareness on Windows domains. Veil will be used to create a python based Meterpreter executable."
echo -e "\e[0m"
git clone https://github.com/Veil-Framework/Veil /opt/Veil
cd /opt/Veil/ && ./Install.sh -c
echo "*************************************************************"
echo -e "\e[31mInstalling Fuzzing Lists -SecLists"
echo -e "\e[32mThese are scripts to use with Burp to fuzz parameters"
echo -e "\e[0m"
git clone https://github.com/danielmiessler/SecLists.git /opt/SecLists
echo "*************************************************************"
echo -e "\e[31mInstalling Net-Creds Network Parsing"
echo -e "\e[32mParse PCAP files for username/passwords"
echo -e "\e[0m"
git clone https://github.com/DanMcInerney/net-creds.git /opt/net-creds
echo "*************************************************************"
echo -e "\e[31mInstalling Wifite"
echo -e "\e[32mAttacks against WiFi networks"
echo -e "\e[0m"
git clone https://github.com/derv82/wifite /opt/wifite
echo "*************************************************************"
echo -e "\e[31mInstalling WIFIPhisher"
echo -e "\e[32mAutomated phishing attacks against WiFi networks"
echo -e "\e[0m"
